...
<head>
<meta property="fb:app_id" content="1118701071638320" />
<meta property="fb:admins" content="100003688078501"/>		
...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.1&appId=1118701071638320&autoLogAppEvents=1';
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel" style="margin-bottom: 15px;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="http://localhost/WebAnhThi/WebMot/wp-content/uploads/2018/09/COVER_AVATAR2.png" alt="First slide">
    </div>

    <div class="carousel-item">
      <img class="d-block w-100" src="http://localhost/WebAnhThi/WebMot/wp-content/uploads/2018/09/COVER_AVATAR2.png" alt="Third slide">
    </div>
  </div>
